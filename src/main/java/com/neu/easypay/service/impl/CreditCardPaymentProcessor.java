...
public class CreditCardPaymentProcessor extends PaymentProcessorWithDbPersist {
  ...
  public PaymentProcessingResult processPayment(String payerId, CardInfo cardInfo, String userId, Double amount) {
    ...
    // Persist details.
    return persistPaymentDetail(transactionStatus, transactionStatusMessage, payerId, cardInfo,
        amount, userId);
  }
